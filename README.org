...
Currently om-dash implementats a few configurable dynamic blocks:
...
(Here, =claws2json= is a small script I wrote that reads =folderlist.xml= file maintained by Claws Mail and prints a table in JSON format.)
